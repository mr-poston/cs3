...
def file_check():
    ...
    check50.run("java Acronyms").stdout("I drove my Pick Up to Texas State Optical to get a Hard Drive\.\s*My.*\\nCentral Processing Unit has a virus\.\s*I sometimes Strike Out.*\\nwhen trying to kick a Field Goal\.\s*I had 2 Runs Batted In.*\\nat the game\..*", regex=True).exit(0)
